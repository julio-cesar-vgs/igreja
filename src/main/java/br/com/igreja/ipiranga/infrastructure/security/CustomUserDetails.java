...
/**
 * Implementação personalizada de UserDetails.
 * Camada: Infrastructure
 * 
 * Envolve a entidade Usuario para que o Spring Security possa gerenciar
 * a autenticação e autorização baseada em roles.
 */
